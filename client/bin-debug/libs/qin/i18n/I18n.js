...
(function (qin) {
    ...
    var I18n = (function () {
        ...
        I18n.initSystem = function (uslang, langs) {
            ...
            I18n._langs = langs;
            if (qin.StringUtil.isNullOrEmpty(uslang) == false) {
        ...
        I18n.initMap = function (data) {
            I18n._map = null;
            if (qin.StringUtil.isNullOrEmpty(data) == false) {
        ...
        I18n.getText = function (key) {
            if (I18n._map == null || qin.StringUtil.isNullOrEmpty(key)) {
                return key;
            }
    ...
    qin.I18n = I18n;
    __reflect(I18n.prototype, "qin.I18n");
})(qin || (qin = {}));
