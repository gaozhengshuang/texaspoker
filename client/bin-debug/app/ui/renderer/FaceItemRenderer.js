...
var FaceItemRenderer = (function (_super) {
    ...
    FaceItemRenderer.prototype.loadFace = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.bindData) return [3 /*break*/, 2];
                        return [4 /*yield*/, RES.getResAsync(ResPrefixPathName.Emoji + this.bindData.source)];
                    case 1:
                        data = _a.sent();
