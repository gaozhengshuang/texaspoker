 ...
 * 商城金币项
*/
var GoldItemComponent = (function (_super) {
    __extends(GoldItemComponent, _super);
    function GoldItemComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GoldItemComponent.prototype.onEnable = function (event) {
        _super.prototype.onEnable.call(this, event);
        this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.buy, this);
    };
    GoldItemComponent.prototype.onDisable = function (event) {
        this.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.buy, this);
        _super.prototype.onDisable.call(this, event);
    };
    GoldItemComponent.prototype.init = function (info) {
    ...
    GoldItemComponent.prototype.buy = function () {
    ...
    return GoldItemComponent;
}(BaseComponent));
__reflect(GoldItemComponent.prototype, "GoldItemComponent");
//# sourceMappingURL=GoldItemComponent.js.map