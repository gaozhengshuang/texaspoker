...
//// 获取平台金币
//func (u *RoomUser) SynMidasBalance() {
//	event := NewQueryPlatformCoinsEvent(u.DoSynMidasBalance, u.DoSynMidasBalanceResult)
//	u.AsynEventInsert(event)
//}
//
//// 同步midas余额
//func (u *RoomUser) DoSynMidasBalance() (balance, amt_save int64, errmsg string) {
//	return def.HttpWechatMiniGameGetBalance(Redis(), u.OpenId())
//}
//
//// 同步midas余额
//func (u *RoomUser) DoSynMidasBalanceResult(balance, amt_save int64, errmsg string) {
//	u.synbalance = false
//	if errmsg != "" {
...
//		//send := &msg.BT_SynUserRechargeMoney{ Userid:pb.Int64(u.Id()), Diamond:pb.Int32(recharge) }
...
//
//// 从midas服务器扣除金币
//func (u *RoomUser) SynRemoveMidsMoney(amount int64, reason string) {
//	event := NewRemovePlatformCoinsEvent(amount, u.DoRemoveMidasMoney, u.DoRemoveMidasMoneyResult)
//	u.AsynEventInsert(event)
//	log.Info("玩家[%s %d] 同步扣除midas金币 amount:%d reason:%s", u.Name(), u.Id(), amount, reason)
//}
//
//func (u* RoomUser) DoRemoveMidasMoney(amount int64) (balance int64, errmsg string) {
//	return def.HttpWechatMiniGamePayMoney(Redis(), u.OpenId(), amount)
//}
//
//func (u* RoomUser) DoRemoveMidasMoneyResult(balance int64, errmsg string, amount int64) {
//	if errmsg != "" {
...
//
//// 从midas服务器添加金币
//func (u *RoomUser) SynAddMidsMoney(amount int64, reason string) {
...
//}
//
//func (u *RoomUser) DoAddMidasMoney(amount int64) (balance int64, errmsg string) {
//	return def.HttpWechatMiniGamePresentMoney(Redis(), u.OpenId(), amount)
//}
//
//func (u *RoomUser) DoAddMidasMoneyResult(balance int64, errmsg string, amount int64) {
//	if errmsg != "" {
