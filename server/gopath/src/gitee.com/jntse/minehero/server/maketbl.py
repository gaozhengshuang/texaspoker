...
gen.maketbl_excel('HoleCards', 'holecards', 'THoleCards.xlsx')
...
gen.maketbl_excel('TChampionship','championship','TChampionship.xlsx')
...
gen.maketbl_json('table', 'TexasFight', 'texasfight.json')
