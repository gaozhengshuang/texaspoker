...
#gen.maketbl_excel('TCarPartBase','carpartbase','TCarPart.xlsx')
#gen.maketbl_excel('TCarPartLevelupBase','carpartlevelupbase','TCarPartLevelup.xlsx')
#gen.maketbl_excel('TCarStarAttrBase','carstarattrbase','TCarStarAttr.xlsx')
#gen.maketbl_excel('TLevelCarPartBase','levelcarpartbase','TLevelCarPart.xlsx')
#gen.maketbl_excel('TCarBrandBase','carbrandbase','TCarBrand.xlsx')
#gen.maketbl_excel('TCarModelBase','carmodelbase','TCarModel.xlsx')
#gen.maketbl_excel('TParkingBase','parkingbase','TParking.xlsx')
#gen.maketbl_excel('TStarupCarBase','starupcarbase','TStarupCar.xlsx')
...
#gen.maketbl_excel('TSupermarketBase','supermarketbase','TSupermarket.xlsx')
#gen.maketbl_excel('CarPartsShopBase','carpartsshopbase','TCarPartsShop.xlsx')
#gen.maketbl_excel('HousePartsShopBase','housepartsshopbase','THousePartsShop.xlsx')
