...
public class UniversalLoadingView extends ViewGroup{
    ...
    private static final String LOAD_FAILED_TIP = "loading failed and try again";
    private static final String LOAD_EMPTY_TIP = "nothing";
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        sHeight = MeasureSpec.getSize(heightMeasureSpec) * 18 / 10;
