...
import com.jiantfuntexaspoker.main.billing.row.GasDelegate;
import com.jiantfuntexaspoker.main.billing.row.GoldMonthlyDelegate;
import com.jiantfuntexaspoker.main.billing.row.GoldYearlyDelegate;
import com.jiantfuntexaspoker.main.billing.row.PremiumDelegate;
...
public class MainViewController {
    ...
    private static int[] TANK_RES_IDS = { R.drawable.gas0, R.drawable.gas1, R.drawable.gas2,         R.drawable.gas2, R.drawable.gas4 };
    private final UpdateListener mUpdateListener;
    private GoogleBillingVst mActivity;
    ...
    public MainViewController(GoogleBillingVst activity) {
