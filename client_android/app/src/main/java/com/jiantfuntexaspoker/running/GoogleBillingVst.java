...
import com.jiantfuntexaspoker.running.billing.AcquireFragment;
    ...
    public void onPurchaseButtonClicked(JSONObject data) {
        ...
        try {
            if (mBillingManager != null
                ...
                switch (awardId) {
                    case 801:
//                        _target.googleBillingVst.mBillingManager.initiatePurchaseFlow("gas", BillingClient.SkuType.INAPP);

                        mAcquireFragment.querySkuDetails("gas");
                        break;
                    case 802:
//                        _target.googleBillingVst.mBillingManager.initiatePurchaseFlow("premium", BillingClient.SkuType.INAPP);
