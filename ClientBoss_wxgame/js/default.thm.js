var egret = window.egret;
	...
	function ShoppingCartSkin() {
		_super.call(this);
		this.skinParts = ["BG","listGroup","ShopItemViewScroller","BG3","goldNumTxt","userCoin","diamondNumTxt","userDiamond","btn_close","other","BG2","coinGoldImage","coinDiamondImage","totalCost_gold","totalCost_diamond","btn_buy","shopNumBg","shopNum"];
		
		this.height = 1100;
		this.width = 720;
		this.elementsContent = [this.BG_i(),this._Group1_i(),this.other_i(),this._Group2_i()];
	}
	...
	_proto.other_i = function () {
		...
		t.width = 0;
		t.elementsContent = [this.BG3_i(),this.userCoin_i(),this.userDiamond_i(),this.btn_close_i()];
		return t;
	};
