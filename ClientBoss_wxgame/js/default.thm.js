var egret = window.egret;
	...
	function BattleSceneSkin() {
		_super.call(this);
		this.skinParts = ["doubleAnim","brickInfoGroup","light1","light2","light3","doubleGroup","topBg","touchGroup","buffGroup","showGroup","moreFireImg","paddleGroup","debugGroup","luckyButton","userButton","rechargeButton","bagButton","backButton","mainGroup","penetrationBallImage","penetrationLabel","penetrationGroup","ballButton1","ballButton2","ball1Price","ball2Price","ballGroup","scoreLabel","hitLabel","noticeLabel","guideGroup","badbuffPanel","badBuffGroup"];
		
		this.height = 1100;
		this.width = 720;
		this.doubleAnim_i();
		this.elementsContent = [this._Image1_i(),this.brickInfoGroup_i(),this.doubleGroup_i(),this.topBg_i(),this.touchGroup_i(),this.mainGroup_i(),this.penetrationGroup_i(),this.ballGroup_i(),this.scoreLabel_i(),this.hitLabel_i(),this.noticeLabel_i(),this.guideGroup_i(),this.badBuffGroup_i()];
	...
	_proto.mainGroup_i = function () {
		...
		t.touchEnabled = false;
		t.width = 720;
		t.elementsContent = [this._Image2_i(),this.buffGroup_i(),this.showGroup_i(),this.paddleGroup_i(),this.debugGroup_i(),this.luckyButton_i(),this.userButton_i(),this.rechargeButton_i(),this.bagButton_i(),this.backButton_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
