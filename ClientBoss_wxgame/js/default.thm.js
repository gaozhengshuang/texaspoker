var egret = window.egret;
	...
	_proto.selectImage_i = function () {
		...
		this.selectImage = t;
		t.horizontalCenter = 0;
		t.source = "ui_json.touxiangkuang";
		t.verticalCenter = 0;
		t.visible = false;
		return t;
	};
